...
class ContactAdminController extends Controller
{
    ...
    public function update(Request $request)
    {
        $validated = $request->validate([
            ...
            'outbound_phone' => 'nullable|string|max:50',
            'inbound_phone' => 'nullable|string|max:50',
            'primary_email' => 'nullable|email|max:255',
            'tours_email' => 'nullable|email|max:255',
            'office_address' => 'nullable|string',
            'office_hours_weekday' => 'nullable|string|max:100',
            'office_hours_saturday' => 'nullable|string|max:100',
            'office_hours_sunday' => 'nullable|string|max:100',
