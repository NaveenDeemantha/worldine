...
const faqs = [
    ...
    },
    {
        ...
        answer: "We support secure international credit/debit card payments (Visa, MasterCard), KOKO (Buy Now Pay Later installments), wire bank transfers, and local currency payments. Detailed invoicing and receipt confirmation are provided for every booking."
    },
    {
        ...
        <section id="contact-form" class="py-16 sm:py-20 w-full px-6 sm:px-10 md:px-14 lg:px-20 xl:px-24 bg-slate-100/60">
            <div class="w-full grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
                ...
                <div class="lg:col-span-5 space-y-6">
                    ...
                    <div class="bg-slate-50/90 rounded-2xl p-4 border border-slate-200/80 flex items-center justify-between gap-3">
                        <div class="space-y-0.5">
                            <div class="flex items-center space-x-1.5">
                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                                <span class="text-[11px] font-bold text-slate-800">Flexible Payment Plans</span>
                            </div>
                            <p class="text-[10.5px] text-slate-500 font-medium">Installments via KOKO & Cards</p>
                        </div>
